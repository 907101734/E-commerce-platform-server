...
public class UploadServiceImpl implements UploadService {
    ...
    public FileResultVo upload(MultipartFile multipartFile, String model, String extStr, Integer size) throws IOException {
        ...
        // 文件分隔符转化为当前系统的格式
        // 文件分隔符转化为当前系统的格式
        String webPath = uploadCommonVo.getType() + uploadCommonVo.getModelPath() + DateUtil.nowDate(Constants.DATE_FORMAT_DATE)
            .replace("-", "/") + "/";
        ...
        switch (uploadTypeInt) {
            ...
            case 2:
                ...
                try {
                    ...
                    qiNiuService.uploadFile(uploadManager, cloudVo, upToken,
                        resultFile.getUrl(), webPathQn + "/" + resultFile.getUrl(), file);
                } catch (Exception e) {
            ...
            case 3:
                ...
                try {
                    ...
                    ossService.upload(cloudVo, resultFile.getUrl(), webPathAl + "/" + resultFile.getUrl(),
                        file);
                } catch (Exception e) {
            ...
            case 4:
                ...
                try {
                    ...
                    cosService.uploadFile(cloudVo, resultFile.getUrl(), webPathTx + "/" + resultFile.getUrl(), file, cosClient);
                } catch (Exception e) {

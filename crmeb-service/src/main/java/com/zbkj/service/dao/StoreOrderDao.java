...
public interface StoreOrderDao extends BaseMapper<StoreOrder> {
     ...
     * @return
     */
    Integer getLastProductOrderInfo(@Param("startTime") String startTime,  @Param("productId") Integer productId,@Param("uid") Integer uid);
     ...
     * @return
     */
    Integer getLastOrderInfoByGift(@Param("startTime") String startTime, @Param("giftProperty") Integer giftProperty,@Param("uid") Integer uid);

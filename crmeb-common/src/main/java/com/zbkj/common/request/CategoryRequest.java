...
public class CategoryRequest implements Serializable {
    ...
    @ApiModelProperty(value = "类型，类型，1 产品分类，2 附件分类，3 文章分类， 4 设置分类， 5 菜单分类， 6 配置分类， 7 秒杀配置,8 报单区分类 9 生活区分类 10 门店区分类")
    @NotNull(message = "类型必须选择")
    @Range(min = 1, max = 11, message = "类型，1 产品分类，2 附件分类，3 文章分类， 4 设置分类， 5 菜单分类， 6 配置分类， 7 秒杀配置之间 8 报单区分类 9 生活区分类 10 门店区分类") //取值范围
